    ...
    <main className="max-w-4xl w-full mx-auto py-20 px-4 md:px-10">
      <div className="py-10">
        ...
        <div className="flex lg:flex-row justify-between items-center flex-col mt-20">
          <h1 className="text-base md:text-xl lg:text-4xl bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary font-black mb-2 pb-1">
            {project.title}
          </h1>
        ...
        <div>
          <p className="text-sm lg:text-base font-normal text-secondary max-w-xl mt-4">{project.description}</p>
        </div>
